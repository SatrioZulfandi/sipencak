        ...
        <div class="form-pane">
            <div class="login-box">
                ...
                <?php if (session()->getFlashdata('success')) : ?>
                    <div class="alert alert-success mb-4" style="border-radius: 12px; padding: 14px 18px; border:none; background: #dcfce7; color: #166534; font-weight:600;">
                ...
                <form action="<?= base_url('login') ?>" method="post">
                    ...
                    <div class="form-group-modern">
                        <div class="d-flex justify-content-between">
                            ...
                            <a href="<?= base_url('forgot') ?>" class="small font-weight-bold" style="color: var(--primary); text-decoration: none;">Lupa Password?</a>
                        </div>
                        <div class="input-wrapper">
